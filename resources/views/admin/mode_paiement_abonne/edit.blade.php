<div class="modal fade" id="modal-default{{ $modePaiementAbonne->id }}">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Ajouter un mode Paiement Abone</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('update-modePaiementAbonne', ['id' => $modePaiementAbonne->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nom" value="{{ $modePaiementAbonne->nom }}" class="form-control" id="exampleInput"
