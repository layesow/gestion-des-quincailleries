                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="exampleInput">Nom de la caisse</label>
                                <input type="text" name="solde_initial" class="form-control" id="exampleInput"
                                    placeholder="solde_initial" required>
                            </div>
                            <div class="col-md-6">
                                <label for="exampleInput">Nom de la caisse</label>
                                <input type="text" name="solde_actuel" class="form-control" id="exampleInput"
                                    placeholder="solde_actuel" required>
                            </div>
                        </div>
                    </div>
                </div>
